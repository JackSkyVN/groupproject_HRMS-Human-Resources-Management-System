/**
 * Module AI Insights - Chẩn đoán thời gian thực cho Admin/HR
 */
...
async function refreshDashboard() {
    try {
        ...
        // Cập nhật session count trong header
...
// Global function cho nút Refresh Data
window.refreshAIInsights = async function () {
    ...
    try {
        ...
        // Reload toàn bộ trang với data mới
